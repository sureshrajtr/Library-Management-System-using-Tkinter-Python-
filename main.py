...
co.close()
co=mysql.connector.connect(host='localhost',user='root',password='12345678',database='LIBRARY')
c=co.cursor()
...
class home_page:
    def __init__(self,root):
        ...
        self.r=PhotoImage(file = "issue1.png")      
...
class issue_page:
    def __init__(self,root):
        ...
        self.c=PhotoImage(file = "issue1.png")
...
class stu_update:
    def __init__(self,root):
        ...
        self.a=PhotoImage(file = "lib.png")    
    ...
    def click11(self):
        ...
        if e=='' or e1=='' or e2=='' or e3=='' or e4 =='' or e5=='':
            ...
            self.co=mysql.connector.connect(host='localhost',user='root',password='12345678',database='LIBRARY')
...
class book_search:
    ...
    def click(self):
        ...
        if self.q==[]:
            ...
            self.d=PhotoImage(file = "lib.png")
...
class login():
    def __init__(self,root):
        self.root =Frame(root,height=166,width=238,bg='White').pack()
        ...
        label=Button(root,text='Login',bg="LIGHT BLUE",command=self.log).place(x=100,y=120)
    def log(self):
        USER='dawnlibrary'
        password='dawn123'
        e1=self.user.get()
